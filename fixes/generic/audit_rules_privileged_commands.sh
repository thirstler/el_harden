...
# PRIVILEGED_BINARIES array This could result in a lot of repeats on systems
# without separated partitions but auditd won't care.
PRIVILEGED_BINARIES=(
$(find / -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /boot -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /home -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /opt -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /tmp -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /usr -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /var -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /var/log -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
$(find /var/log/audit -xdev -type f -perm -4000 -o -type f -perm -2000 2>/dev/null)
)
